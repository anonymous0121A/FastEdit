...
def ParseArgs():
	...
	parser.add_argument('--keep_rate', default=0.5, type=float, help='ratio for random masking')
	...
	parser.add_argument('--symetric', default=0, type=int, help='indicating UGCN to be symmetric or not for user/item-side')
	parser.add_argument('--unlearn_rate', default=0.0, type=float, help='ratio of data to unlearn')
	parser.add_argument('--finetune_steps', default=50, type=int, help='number of steps to fine-tune')
	parser.add_argument('--concat', default=0, type=int, help='indicating concat untrained UGCN embedddings or not')
